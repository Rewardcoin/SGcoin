...
int64 nChainStartTime = 1446686555;
...
*/
   ...
   if(nHeight <= 700000)
    {
        nSubsidy = 1000 * COIN;	// 1000 coins per block for the 700000 blocks.
        return nSubsidy + nFees;
    }
...
int64 GetProofOfStakeReward(int64 nCoinAge, unsigned int nBits, unsigned int nTime, int nHeight)
{
	...
	nRewardCoinYear = MAX_SGC_PROOF_OF_STAKE;

	/*if(nHeight < YEARLY_BLOCKCOUNT)
		nRewardCoinYear = 4 * MAX_SGC_PROOF_OF_STAKE;
	else if(nHeight < (2 * YEARLY_BLOCKCOUNT))
		nRewardCoinYear = 3 * MAX_SGC_PROOF_OF_STAKE;
	else if(nHeight < (3 * YEARLY_BLOCKCOUNT))
		nRewardCoinYear = 2 * MAX_SGC_PROOF_OF_STAKE;
*/
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in SGcoin
    bool fStrictPayToScriptHash = true; // Always active in SGcoin
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "SGcoin could be a big business!";
        CTransaction txNew;
        ...
        block.nVersion = 1;
        block.nTime    = 1446675500;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 2779919;
		...
		assert(block.hashMerkleRoot == uint256("0x2fbb849edd04cdf33360945f342885798b54a0d3aef5a3d9d6c9b395a59761d6"));
...
unsigned char pchMessageStart[4] = { 0xec, 0x5d, 0xbd, 0xaf };
